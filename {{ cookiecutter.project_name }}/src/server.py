...
if __name__ == "__main__":
    ...
    {{ cookiecutter.__underscore_name }}_deployment = {{ cookiecutter.__underscore_name }}_flow.to_deployment(
        ...
        description="Code found at: https://github.com/nens/{{ cookiecutter.project_name }}", # Place this in EACH deployment, so that it its clear which repo serves which deployment
